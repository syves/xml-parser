...
(def f (trans-query
          '({:firstname "JIARA", :lastname "HERTZEL", :date-of-birth "1935-06-05", :phone "1111111111"} {:firstname "00226501", :lastname "MCGREWJR", :date-of-birth "1936-02-01", :phone "1111111111"})
          sql-upsert-builder
...
(deftest a-test
  ...
  ;  (is (=
  ;         (trans-query list-map sql-upsert-builder sql-select-contraint-builder))
  ;         ""))
